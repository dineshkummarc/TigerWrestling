...
(function ($) {
	...
	$.fn.validationEngine = function (settings) {
		...
		$(this).bind("submit", function (caller) {   // ON FORM SUBMIT, CONTROL AJAX FUNCTION IF SPECIFIED ON DOCUMENT READY
			//If one of the "report abuse" buttons is clicked, skip validation
			var commentFlagId = $(".hdnCommentFlagId");
			if ((commentFlagId.val() != undefined && commentFlagId.val() != '')) {
				return true;
			}
			...
			//Only AFTER the page is validated, can we push the custom Omniture events
			//alert($.validationEngine.onSubmitValid);
			//alert($.validationEngine.isError);
			//if ($('.btnRsvp').val() == "")
			//	ManageRegistrationSubmit();
		})
